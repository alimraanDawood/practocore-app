...
- **Backend Integration**: PocketBase (http://192.168.0.108:8090)
...
```
- Admin dashboard: http://192.168.0.108:8090/_/
...
All backend communication goes through PocketBase (http://192.168.0.108:8090):
...
- Runtime config: `nuxt.config.ts:86-90` defines `pocketbaseUrl` (defaults to http://192.168.0.108:8090)
...
1. **Start Backend** (Terminal 1):
   ...
   ```
   - Runs on http://192.168.0.108:8090
   - Admin dashboard: http://192.168.0.108:8090/_/
