...
interface NavLink { label: string; icon: LucideIcon; to: string; exact?: boolean; adminOnly?: boolean; needsOrg?: boolean }
                        ...
                        <SidebarMenuItem class="flex flex-row items-center gap-1">
                            ...
                            <SharedSwitchOrganisations>
                                <SidebarMenuButton size="lg" class="min-w-0 flex-1 data-[state=open]:bg-sidebar-accent"
                                    :tooltip="orgName">
                                    <div class="grid size-8 shrink-0 place-items-center rounded-md bg-foreground text-sm font-bold text-background">
